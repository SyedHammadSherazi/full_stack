    ...
    presenceSocketRef.current.onmessage = (event) => {
      ...
      if (data.type === "presence") {
        setOnlineUsers((prev) => {
          ...
          const index = users.findIndex((u) => u.user === data.user);
  ...
  return (
    ...
    >
        ...
        {workspaces.map((workspace) => (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              background:
                selectedWorkspace?.id === workspace.id ? "#ddd" : "#fff",
            }}
          >
            {workspace.name}
          </button>
      ...
      >
        ...
        <FileUpload workspaceId={selectedWorkspace?.id} />
      </div>
